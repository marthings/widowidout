...
class CountersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create counter" do
    assert_difference("Counter.count") do
      post counters_url, params: { counter: { amount: @counter.amount, emoji: @counter.emoji, title: @counter.title } }
    end
  ...
  test "should update counter" do
    patch counter_url(@counter), params: { counter: { amount: @counter.amount, emoji: @counter.emoji, title: @counter.title } }
